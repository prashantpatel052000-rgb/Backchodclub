...
voiceCallBtn.addEventListener("click", async () => {
    ...
    try {
        ...
        // Best-effort: if the caller navigates away/closes the tab while the
// call is still ringing, mark it cancelled so the receiver isn't left
// looking at an incoming-call screen for someone who's gone.
window.addEventListener("beforeunload", () => {
    if (activeCallId) {
        ...
        // Auto-expire an unanswered call after 30 seconds so it
        // doesn't ring forever on the receiver's side.
